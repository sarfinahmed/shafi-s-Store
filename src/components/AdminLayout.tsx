    ...
    <div className="bg-black text-white font-sans md:h-screen w-full flex flex-col md:flex-row selection:bg-zinc-800 selection:text-white">
      ...
      <aside className="w-full md:w-64 bg-black border-b md:border-b-0 md:border-r border-zinc-900 flex flex-col z-10 relative shadow-2xl flex-shrink-0">
        ...
        <nav className="flex-1 px-4 py-2 md:py-0 space-y-0 md:space-y-1 flex md:block overflow-x-auto md:overflow-y-auto whitespace-nowrap scrollbar-hide">
          <Link to="/" className="inline-flex md:flex items-center gap-2 md:gap-3 px-3 md:px-4 py-2 md:py-3 text-sm md:text-base text-zinc-400 hover:bg-zinc-900 hover:text-white rounded-xl font-bold transition-colors mb-2 md:mb-4">
            <Home className="w-4 h-4 md:w-5 h-5 flex-shrink-0" />
            Back to App
          </Link>
          <Link to="/admin" className="inline-flex md:flex items-center gap-2 md:gap-3 px-3 md:px-4 py-2 md:py-3 text-sm md:text-base text-zinc-400 hover:bg-zinc-900 hover:text-white rounded-xl font-bold transition-colors">
            <Package className="w-4 h-4 md:w-5 h-5 flex-shrink-0" />
            Products
          </Link>
          <Link to="/admin/users" className="inline-flex md:flex items-center gap-2 md:gap-3 px-3 md:px-4 py-2 md:py-3 text-sm md:text-base text-zinc-400 hover:bg-zinc-900 hover:text-white rounded-xl font-bold transition-colors">
            <Users className="w-4 h-4 md:w-5 h-5 flex-shrink-0" />
            Users
          </Link>
          <Link to="/admin/deposits" className="inline-flex md:flex items-center gap-2 md:gap-3 px-3 md:px-4 py-2 md:py-3 text-sm md:text-base text-zinc-400 hover:bg-zinc-900 hover:text-white rounded-xl font-bold transition-colors">
