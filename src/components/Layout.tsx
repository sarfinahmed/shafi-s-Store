...
export function Layout() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-black text-black dark:text-white flex flex-col font-sans selection:bg-black selection:text-white dark:selection:bg-white dark:selection:text-black">
      <header className="sticky top-0 z-50 w-full border-b border-zinc-200 dark:border-zinc-900 bg-white/80 dark:bg-black/80 backdrop-blur-md">
        <div className="container mx-auto px-4 md:px-10 h-16 md:h-20 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-1 sm:gap-4 font-semibold">
            <Link to="/">
              <Button variant="ghost" className="px-2 sm:px-4 text-zinc-600 dark:text-zinc-400 hover:text-black dark:text-white hover:bg-zinc-200 dark:bg-zinc-900">
            ...
            {user ? (
              <>
                ...
                <Button variant="ghost" onClick={logout} className="px-2 sm:px-4 text-zinc-600 dark:text-zinc-400 hover:text-red-400 hover:bg-red-950/30">
      ...
      <footer className="border-t border-zinc-200 dark:border-zinc-900 bg-white dark:bg-black text-center py-6 mx-4 md:mx-0 md:py-8 text-xs md:text-sm text-zinc-600 font-medium">
