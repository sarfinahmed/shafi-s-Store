    ...
    <AnimatePresence>
      ...
      >
        <motion.div 
          initial={{ scale: 0.9, y: 20 }}
          animate={{ scale: 1, y: 0 }}
          className="bg-[#0a0a0a] border border-zinc-800 rounded-2xl max-w-md w-full p-8 text-center shadow-2xl"
        >
          ...
          <h2 className="text-2xl font-black text-white tracking-tight mb-3">Under Maintenance</h2>
          <p className="text-zinc-500 font-medium leading-relaxed mb-6">
