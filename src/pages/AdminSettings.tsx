      ...
      <div className="bg-[#0a0a0a] rounded-3xl border border-zinc-900 p-8 shadow-sm space-y-6">
        <div className="space-y-6">
          ...
          <div>
            ...
            />
            <p className="text-xs text-zinc-600 mt-2 font-medium">Main heading on the home page.</p>
          </div>
          ...
          <div>
            ...
            />
            <p className="text-xs text-zinc-600 mt-2 font-medium">Secondary text below the hero title.</p>
          </div>
          ...
          <div>
            ...
            <Input 
              ...
              placeholder="e.g. ৳ or $"
            />
            <p className="text-xs text-zinc-600 mt-2 font-medium">Used across the app to display prices.</p>
          </div>
          ...
          <div>
            ...
            />
            <p className="text-xs text-zinc-600 mt-2 font-medium">Include country code (e.g., 880 for BD). Users will be redirected here after purchases or deposits.</p>
          </div>
